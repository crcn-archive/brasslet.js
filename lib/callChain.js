...
CallChain = (function(_super) {
  ...
  */
  ...
  function CallChain(options) {
    ...
    this.fasten = options.fasten, this.target = options.target, this.methods = options.methods, this.type = options.type, this.callstack = options.callstack;
    ...
    return this[name] = function() {
      ...
      _this.callstack.push(function(next) {
        return setTimeout((function() {
          ...
          targets = toarray(_this.target).filter(function(target) {
            if (!_this._filter) {
              return true;
            }
          ...
          if (_this._limit) {
            targets = targets.slice(0, _this._limit);
          }
